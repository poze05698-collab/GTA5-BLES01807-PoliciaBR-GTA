...
namespace Natives
{
	...
	*/
	...
	opd_s _SET_PED_COMPONENT_VARIATION = { Addresses::Addresses_Natives::Peds_a::SET_PED_COMPONENT_VARIATION, TOC };
	void(*SET_PED_COMPONENT_VARIATION)(Ped ped, int componentId, int drawableId, int textureId, int paletteId) = (void(*)(Ped, int, int, int, int))&_SET_PED_COMPONENT_VARIATION;
	...
	*/
	...
	opd_s _TASK_GO_TO_ENTITY = { Addresses::Addresses_Natives::Peds_a::TASK_GO_TO_ENTITY, TOC };
	void(*TASK_GO_TO_ENTITY)(Entity entity, Entity target, int duration, float distance, float speed, float p5, int p6) = (void(*)(Entity, Entity, int, float, float, float, int))&_TASK_GO_TO_ENTITY;
	...
	*/
	...
	opd_s _TASK_VEHICLE_CHASE = { Addresses::Addresses_Natives::Peds_a::TASK_VEHICLE_CHASE, TOC };
	void(*TASK_VEHICLE_CHASE)(Ped driver, Entity target) = (void(*)(Ped, Entity))&_TASK_VEHICLE_CHASE;

	opd_s _TASK_VEHICLE_DRIVE_WANDER = { Addresses::Addresses_Natives::Peds_a::TASK_VEHICLE_DRIVE_WANDER, TOC };
	void(*TASK_VEHICLE_DRIVE_WANDER)(Ped driver, Vehicle vehicle, float speed, int drivingStyle) = (void(*)(Ped, Vehicle, float, int))&_TASK_VEHICLE_DRIVE_WANDER;

	opd_s _SET_VEHICLE_SIREN = { Addresses::Addresses_Natives::Vehicles_a::SET_VEHICLE_SIREN, TOC };
	void(*SET_VEHICLE_SIREN)(Vehicle vehicle, BOOL toggle) = (void(*)(Vehicle, BOOL))&_SET_VEHICLE_SIREN;
